...
module Ea
  module Validation
    RSpec.describe CompaniesHouseNameValidator do
      class NameValidatable
        include ActiveModel::Model
        include ActiveModel::Validations

        attr_accessor :name
        validates :name, "ea/validation/companies_house_name" => true
      end
      ...
      describe "Disallowed special chars" do
        CompaniesHouseNameValidator.disallowed_chars.each do |char|
